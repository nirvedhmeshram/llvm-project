...
/// testMap that is contained in location testMapLocation of
/// SmallVector<AffineMap> Maps but not in any other locations
static bool hasaUniqueDim(SmallVector<AffineMap> Maps,
                          unsigned testMapLocation) {
